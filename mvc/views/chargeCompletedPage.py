...
"""
PolyCharge-Station charge completed page. This page is used when a charging is completed.
"""
...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "Charge Completed!"))
        self.label_2.setText(_translate("Form", "Battery Level"))
        self.label_3.setText(_translate("Form", "Charging Time"))
        self.label_4.setText(_translate("Form", "Price"))
        self.pushButton.setText(_translate("Form", "Logout"))

    def add_action_events(self):
        self.pushButton.clicked.connect(self.on_click_logout)
