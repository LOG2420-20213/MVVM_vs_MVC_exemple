...
"""
PolyCharge concrete station class. This class is a type of station. The type is ultra fast
"""
...
class StationUltraFast(Station):

    def __init__(self, id, station_db):
        super().__init__(id, station_db)
        self.price_per_min = 12
        self.percent_per_min = 4
